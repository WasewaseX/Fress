      ...
      >
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <p>
                  When clicking external links to GitHub repositories or official software websites, requests connect directly from your browser to those respective third-party domains. All links contain <code className="font-mono text-sky-300">rel="noopener noreferrer"</code> to protect your privacy and prevent referrer header leakage.
                </p>
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="bg-slate-950 border border-slate-800 p-3 rounded flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-slate-400 text-[11px] mt-0.5">
                      Remembers your preferred sorting order, category selections, and recent search history between sessions.
                    </p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="bg-slate-950 border border-slate-800 p-3 rounded flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-slate-400 text-[11px] mt-0.5">
                      Optional local error diagnostic logging. No third-party network transmission is performed.
                    </p>
                  </div>
                  <input
                    type="checkbox"
        ...
        <div className="p-4 border-t border-slate-950/10 dark:border-white/[0.08] bg-slate-950 flex items-center justify-between">
          <span className="text-[11px] text-slate-400">
            Compliance status: Verified Local-First & GDPR Compliant
          </span>
          <button
            type="button"
            onClick={onClose}
