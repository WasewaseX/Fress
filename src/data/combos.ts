...
export const COMBOS: Combo[] = [
  ...
  },
  {
    ...
    note: 'F-Droid is the open-source app store and the safest place to install from outside Play. NewPipe plays YouTube without an account or ads, Organic Maps works fully offline, AntennaPod handles podcasts, Termux opens a real Linux terminal, KeePassDX keeps your vault in your pocket, and the Fossify Calendar and Contacts apps replace the stock Google ones with versions that have no internet permission at all.',
    icon: Smartphone,
    tile: 'bg-lime-500/15 text-lime-400',
    appIds: ['f-droid', 'newpipe', 'organicmaps', 'antennapod', 'keepassdx', 'termux', 'fossify-calendar', 'fossify-contacts'],
  },
  {
    id: 'fresh-setup',
  ...
  },
  {
    ...
    note: 'LibreOffice handles documents and spreadsheets in every format your school or office uses. Joplin keeps synced notebooks with Markdown and end-to-end encryption, Zotero collects papers and spits out citations in 10,000 styles, Calibre runs the e-book library, and LibreTranslate translates the rough edges without sending your text to Google.',
    icon: NotebookPen,
    tile: 'bg-cyan-500/15 text-cyan-400',
    appIds: ['libreoffice', 'joplin', 'zotero', 'calibre', 'libretranslate'],
  },
  {
    id: 'complete-pack',
    name: 'Complete privacy pack',
    purpose: 'The whole stack, from mail to browser, in one kit.',
    note: 'LibreWolf browses without telemetry, Proton VPN and Mullvad VPN hide your traffic (pick one, they are both audited), Proton Mail or Tuta carry your mail with default encryption, Signal and SimpleX handle messages, Bitwarden holds the passwords, Ente Auth the second factors, and Cryptomator locks anything that touches a cloud. Install the whole list or pick your corner; every piece is free software and none of it reports home.',
    icon: Shield,
    tile: 'bg-purple-500/15 text-purple-400',
    appIds: ['librewolf', 'proton-vpn', 'mullvad-vpn', 'proton-mail', 'tuta', 'signal', 'simplex', 'bitwarden', 'ente-auth', 'cryptomator'],
  },
  {
    id: 'encrypted-cloud',
    name: 'Encrypted cloud',
    purpose: 'Keep the convenience of sync, lose the ability to be read.',
    note: 'Cryptomator wraps a folder in an audited vault so Dropbox or Google Drive only ever see scrambled names and equal-sized blocks. Nextcloud is the self-hosted drive underneath when you are ready to drop the commercial cloud entirely, and Syncthing moves the same folders device to device with no server in the middle at all.',
    icon: Lock,
    tile: 'bg-stone-500/15 text-stone-400',
    appIds: ['cryptomator', 'nextcloud', 'syncthing'],
  },
  {
    id: 'media-server',
    name: 'Media server',
    purpose: 'Your movie and music library on every screen at home.',
    note: 'Jellyfin runs the server that organizes and streams your library to phones, TVs and browsers, with no account and no paid unlocks. qBittorrent fetches what you decide to fetch without ads or bundled junk, and VLC plays the odd formats nothing else opens.',
    icon: Server,
    tile: 'bg-yellow-500/15 text-yellow-400',
    appIds: ['jellyfin', 'qbittorrent', 'vlc'],
  },
  {
    id: 'self-hosted-home',
